  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/project/amman-rotana-hotel-2019" element={<AmmanRotanaHotel2019 />} />
        <Route path="/blog/the-role-of-technology-in-modern-architecture" element={<TheRoleOfTechnologyInModernArchitecture />} />
