                            ...
                            <div className="rounded-2xl p-6 text-center">
                                <div className="relative group w-fit mx-auto mb-6">
                                    ...
                                    <div className="absolute inset-0 bg-[#495944]/60 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-all duration-500 rounded-full">
                                        <a href="#" className="text-white hover:text-[#D1BAA2] text-lg"><FaFacebook /></a>
                                        <a href="#" className="text-white hover:text-[#D1BAA2] text-lg"><FaTwitter /></a>
                                        <a href="#" className="text-white hover:text-[#D1BAA2] text-lg"><FaInstagram /></a>
                                    </div>
                                </div>
                                <p className="text-sm text-gray-600 italic mb-4">&quot;{item.description}&quot;</p>
                                <h4 className="text-[#495944] font-semibold text-lg">{item.name}</h4>
                                <p className="text-xs uppercase text-gray-500 tracking-wide">{item.position}</p>
                                <div className="text-[#D1BAA2] mt-2 text-sm">★★★★★ {item.rating.toFixed(1)}</div>
                            </div>
                        </SplideSlide>
                    ))}
                </Splide>
