      ...
      <div className="flex flex-wrap gap-12 justify-between">
        ...
        <div className="w-full md:w-[48%] lg:w-[25%] space-y-5">
          ...
          <div className="flex gap-4 text-xl text-white">
            <a href="#" aria-label="Facebook" className="hover:text-[#D1BAA2] transition-all duration-200">
              <FaFacebookF />
            </a>
            <a href="#" aria-label="Twitter" className="hover:text-[#D1BAA2] transition-all duration-200">
              <FaTwitter />
            </a>
            <a href="#" aria-label="Instagram" className="hover:text-[#D1BAA2] transition-all duration-200">
              <FaInstagram />
            </a>
          </div>
        </div>
