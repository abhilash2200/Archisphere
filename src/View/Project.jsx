    ...
    <Layout>
      <div className="container mx-auto px-4 py-12 mt-20">
        ...
        >
          {projects.map((project, index) => (
            <SplideSlide
              key={index}
              className="flex flex-wrap justify-around items-center gap-y-6"
            >
              {/* Image Section */}
                ...
                <div className="bg-transparent p-6 rounded-xl transition-all duration-500 ">
                  <div className="flex flex-row items-center mb-2 -ml-[80px]">
                    ...
                    <p className="text-sm font-medium text-[#7A7A7A]">
                      <span className="text-[#495944] text-2xl font-semibold">
                        {project.year}
                      </span>
                    </p>
                  </div>
      ...
      <div className="bg-[#F5F5F5] py-20 px-6">
        <div className="container mx-auto text-center">
          <h2 className="text-sm tracking-[0.2em] text-[#D1BAA2] uppercase mb-3 font-medium">
            Recognition
          </h2>
          <h3 className="text-[#495944] text-4xl md:text-5xl font-bold uppercase mb-6">
            Awards & Accolades
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-left">
            ...
            <div className="bg-white shadow-lg rounded-2xl p-6 hover:-translate-y-1 hover:shadow-xl transition duration-300 ease-in-out">
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-xl font-semibold text-[#495944]">
