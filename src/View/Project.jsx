  ...
  return (
    <Layout>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="w-full md:w-[60%] lg:w-[60%] overflow-hidden rounded-xl"
              >
                <img
                  src={project.img}
                  alt={project.title}
      ...
      <div className="bg-[#F5F5F5] py-12 md:py-20 px-4 md:px-6">
        <div className="container mx-auto text-center">
          <motion.h2
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="text-xs md:text-sm tracking-[0.2em] text-[#D1BAA2] uppercase mb-2 md:mb-3 font-medium"
          >
            Recognition
          </motion.h2>
          ...
          <motion.h3
            ...
            viewport={{ once: true }}
            className="text-[#495944] text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold uppercase mb-4 md:mb-6"
          >
            Awards & Accolades
          </motion.h3>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-[#505050] max-w-2xl mx-auto mb-8 md:mb-12 text-sm md:text-base lg:text-lg"
          >
            Our projects have earned prestigious international awards recognizing
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-10 text-left">
            {[
              {
                icon: "🏙️",
                title: "Best Urban Project 2023",
                desc: "Awarded by Global Architecture Forum for the Cultural Complex Centre.",
              },
              {
                icon: "🌿",
                title: "Green Building Award",
                desc: "Recognized for eco-conscious design in Dalbourne Villa.",
              },
              {
                icon: "🏨",
                title: "Hospitality Design Winner",
                desc: "Amman Rotana Hotel selected for its innovative hospitality architecture.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
                ...
                viewport={{ once: true }}
                className="bg-white shadow-md md:shadow-lg rounded-xl md:rounded-2xl p-4 md:p-6 hover:-translate-y-1 hover:shadow-lg transition duration-300 ease-in-out"
              >
                <div className="flex items-center mb-3 md:mb-4">
                  <span className="text-[#D1BAA2] text-2xl md:text-3xl mr-3 md:mr-4">
                    {item.icon}
                  </span>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="bg-[#495944] py-16 md:py-24 px-4 md:px-6 text-white text-center relative overflow-hidden"
      >
        <div className="container mx-auto relative z-10">
          <motion.h3
            ...
            viewport={{ once: true }}
            className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-extrabold uppercase mb-4 md:mb-6 tracking-wide"
          >
          ...
          <motion.p
            ...
            transition={{ duration: 0.5, delay: 0.2 }}
            viewport={{ once: true }}
            className="max-w-2xl mx-auto mb-6 md:mb-10 text-sm md:text-base lg:text-lg text-[#E6E6E6]"
          >
            Partner with{" "}
