...
const About = () => {
  return (
    <Layout>
      {/* Hero Section */}
      <section className="bg-[#495944] text-white py-12 md:py-20 text-center px-4 mt-20">
        <div className="container mx-auto">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold uppercase mb-3 md:mb-4">
            About Archisphere
          </h1>
          <p className="text-base md:text-lg max-w-2xl mx-auto text-[#e5e5e5]">
      ...
      <section className="py-12 md:py-20 px-4 bg-[#F5F5F5]">
        <div className="container mx-auto text-center max-w-3xl">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-[#2D3E2F] uppercase tracking-wider mb-4 md:mb-6 relative inline-block">
            <span className="relative z-10">Our Mission</span>
            <span className="absolute left-0 -bottom-1 w-full h-1 bg-[#A3B18A] z-0 rounded-full"></span>
          </h3>
          <p className="text-[#4A4A4A] text-base md:text-lg lg:text-xl leading-relaxed">
      ...
      <section className="py-12 md:py-20 px-4">
        <div className="container mx-auto max-w-5xl text-center">
          <h3 className="text-2xl md:text-3xl font-bold text-[#495944] uppercase mb-4 md:mb-6">
            Our People
          </h3>
          <p className="text-[#555] mb-6 md:mb-8 text-sm md:text-base">
