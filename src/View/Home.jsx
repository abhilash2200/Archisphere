                ...
                <div className='flex flex-wrap justify-between items-center'>
                    ...
                    <div className='w-full lg:w-1/2 md:w-1/2 px-4'>
                        <div className='relative mb-8'>
                            <h2 className='text-[25px] font-normal tracking-[5px] uppercase text-[#D1BAA2] after:content[""] after:absolute after:bottom-0 after:left-0 after:w-20 after:h-0.5 after:bg-[#495944]'>About Us</h2>
                        </div>
                        <h3 className='text-[#495944] text-4xl font-semibold uppercase mb-16 font-nunito'>Break out of your routine with a global perspective.</h3>
                        <p className='mb-4 font-poppins text-[18px] text-[#505050]'>Based on collective work and shared knowledge, Architecture-Studio aims to favour dialogue and debate, to transform individual knowledge into increased creative potential.</p>
                        <p className='mb-4 font-poppins text-[18px] text-[#505050]'>Our Studio is a architecture practice based in Prague, Chech and Venice. Today, it includes 150 architects, urban planners, landscape and interior designers of 25 different nationalities. The company principle of Architecture-Studio is the collective conception. From the very beginning, the practice has believed in the virtues of exchange, crossing ideas, common effort, shred knowledge.</p>
                        <div className='flex justify-start mt-8'>
                            <button className='bg-[#495944] text-white font-roboto tracking-wide capitalize px-8 py-3 rounded-md hover:bg-white hover:text-[#495944] hover:border hover:border-[#495944] transition-colors duration-300 hover:cursor-pointer' onClick={() => window.location.href = '/About'}>
                                Learn More
                            </button>
                        </div>
                    </div>
